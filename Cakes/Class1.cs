            ...
            switch (feature)
            {
                case 1:
                    response = new List<SubParam>()
                    {
                        ...
                        new SubParam() { title = "Трапеция", price = 80 },
                        new SubParam() { title = "Сердечко", price = 70 },
                        new SubParam() { title = "Треугольник", price = 180 }
                    };
                    break;
                case 2:
                    response = new List<SubParam>()
                    {
                        ...
                        new SubParam() { title = "XXL", price = 500 }
                    };
                    break;
                case 3:
                    response = new List<SubParam>()
                    {
                        ...
                        new SubParam() { title = "Ваниль", price = 1300 },
                    };
                    break;
                case 4:
                    response = new List<SubParam>()
